...
class AutoLabeler:
    def __init__(self,
        ...
        self.target_obj_collections = [bpy.data.collections["VehicleCollection"],bpy.data.collections["SignCollection"]]
        self.obj_name_and_class_id_mapping = {
            "Sedan" : 0,
            "SUV" : 1,
            "Van" : 2,
            "Truck" : 3,
