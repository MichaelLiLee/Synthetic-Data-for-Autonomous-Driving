...
class VehiclePlacementRandomizer:
    def __init__(self):
        ...
        self.vehicle_distance = {"min":15,"max":100}
        ...
        self.num_vehicle_need_import = 0
    ...
    def import_vehicle_asset(self):
        ...
        ##randomly select k(k=num_vehicle_need_import) vehicle asset from vehicle_asset_path_list, then import to VehicleCollection
        vehicle_asset_path_list_selected = random.choices(vehicle_asset_path_list, k = self.num_vehicle_need_import)
    ...
    def vehicle_placement_randomize(self):
        ...
        self.num_vehicle_need_import = len(vehicle_loc_list)
        print(f"vehicle_loc:\n{vehicle_loc_list}")
        print(f"num_vehicle_need_import:{self.num_vehicle_need_import}")
        self.import_vehicle_asset()
        ...
        for i in range(self.num_vehicle_need_import):
